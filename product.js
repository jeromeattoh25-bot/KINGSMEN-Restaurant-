// ---------- PRODUCT DATABASE ----------
    const products = [
        { id: 1, name: "fufu", description: "our kingsmen banku has a great teste", brand: "KINGSMEN", price: 40, originalPrice: 60, discount: "26%", image: "productimage/IP.jpg" },
        { id: 2, name: "Waakye",  description: "our kingsmen waakye has a great teste", brand: "KINGSMEN", price: 55, originalPrice: 85, discount: "35%", image: "productimage/it.jpg" },
        { id: 3, name: "jollof",  description: "our kingsmen jollof has a great teste", brand: "KINGSMEN", price: 32, originalPrice: 50, discount: "36%", image: "productimage/we.png" },
        { id: 4, name: "banku",  description: "our kingsmen jollof has a great teste", brand: "KINGSMEN", price: 32, originalPrice: 50, discount: "36%", image: "productimage/sd.jpeg" },
        { id: 5, name: "jollof", description: "our kingsmen jollof has a great teste", brand: "KINGSMEN", price: 70, originalPrice: 110, discount: "36%", image: "productimage/sf.jpg" }
    ];
    ...
    function saveCart() {
        localStorage.setItem('kingsmen_cart', JSON.stringify(cart));
    }
    
    function loadCart() {
        const saved = localStorage.getItem('Kingsmen_cart');
        if (saved) {
    ...
    if (checkoutForm) {
        checkoutForm.addEventListener('submit', function(e) {
            ...
            const mailtoLink = `mailto:jeromeattoh25@gmail.com.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
